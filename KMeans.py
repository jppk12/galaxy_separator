...
g09_ir_opt = g09_ir.merge(g09_opt[['component_id','logn2ha','logo3hb','logo2hb','HA_EW','absmag_u',
                          'absmag_g','logmstar','BPT_index','Blue_index','WHAN_index','MEx_index',
                          'CEx_index','Optical_index','NII_corr','OIII_corr','HA_corr','HB_corr']],
                          on=['component_id'],how='inner')
...
IR_index[(g23_ir.assef_index==1)|(g23_ir.mat_index==1)|(g23_ir.ki_index==1)] = 1
g23_ir['IR_index'] = IR_index

#-----------------------#
# Optical combinations
#-----------------------#
g23_ir_opt = g23_ir.merge(g23_opt[['Source_Name','BPT_index','Blue_index','WHAN_index','MEx_index',
                        'CEx_index','Optical_index','NII_corr','OIII_corr','HA_corr','HB_corr']],
                         on=['Source_Name'],how='inner')
                          #len(g23_ir_opt[(g23_ir_opt.Optical_index==1)&(g23_ir_opt.IR_index==1)]) IR+opt
g23_radio_opt = g23_radio.merge(g23_opt[['Source_Name','BPT_index','Blue_index','WHAN_index','MEx_index',
                                'CEx_index','Optical_index','NII_corr','OIII_corr','HA_corr','HB_corr']],
                                on=['Source_Name'],how='inner')
...
input_matrix_scaled.index = input_matrix.index
# inpu_matrix_scaled.aggregate(['mean','std'])
#-----------------#
# Correlation
#-----------------#
corr_matrix = input_matrix.corr(method='pearson')
...
input_matrix_scaled = input_matrix_scaled[input_matrix_scaled.OIII_corr<10]
input_matrix_scaled = input_matrix_scaled[input_matrix_scaled.NII_corr<10]
...
for k in n_clusters:
    ...
    silhouette_scores.append(silhouette_score(input_matrix, model.named_steps['kmeans'].labels_))
...
model = make_pipeline(StandardScaler(), KMeans(n_clusters=n_clusters, random_state=42))
model.fit(input_matrix)
labels = model.named_steps["kmeans"].labels_

x_grp_by_label = input_matrix.groupby(labels).mean()
...
#--------------------#
# Assigning the index
g09_opt_ir_radio['KMeans'] = labels
...
plt.subplot(221)
#sns.scatterplot(x=g09_opt_ir_radio.logn2ha[g09_opt_ir_radio.KMeans==0],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==0],color='black')
#sns.scatterplot(x=g09_opt_ir_radio.logn2ha[g09_opt_ir_radio.KMeans==1],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==1],color='grey')
sns.kdeplot(data=g09_opt_ir_radio,x='logn2ha',y='logo3hb', hue='KMeans',fill=True, legend=False)
...
plt.subplot(222)
#sns.scatterplot(x=g09_opt_ir_radio.logmstar[g09_opt_ir_radio.KMeans==0],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==0],color='black')
#sns.scatterplot(x=g09_opt_ir_radio.logmstar[g09_opt_ir_radio.KMeans==1],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==1],color='grey')

sns.kdeplot(data=g09_opt_ir_radio,x='logmstar',y='logo3hb', hue='KMeans',fill=True, legend=False)
...
plt.subplot(223)
#sns.scatterplot(x=g09_opt_ir_radio.logo2hb[g09_opt_ir_radio.KMeans==0],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==0],color='black')
#sns.scatterplot(x=g09_opt_ir_radio.logo2hb[g09_opt_ir_radio.KMeans==1],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==1],color='grey')

sns.kdeplot(data=g09_opt_ir_radio,x='logo2hb',y='logo3hb', hue='KMeans',fill=True, legend=False)
...
plt.subplot(224)
#sns.scatterplot(x=g09_opt_ir_radio.absmag_u[g09_opt_ir_radio.KMeans==0]-
#                g09_opt_ir_radio.absmag_g[g09_opt_ir_radio.KMeans==0],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==0],color='black')
#sns.scatterplot(x=g09_opt_ir_radio.absmag_u[g09_opt_ir_radio.KMeans==1]-
#                g09_opt_ir_radio.absmag_g[g09_opt_ir_radio.KMeans==1],
#                y=g09_opt_ir_radio.logo3hb[g09_opt_ir_radio.KMeans==1],color='grey')

sns.kdeplot(data=g09_opt_ir_radio,x='u_g',y='logo3hb', hue='KMeans',fill=True, legend=False)
...
sns.kdeplot(data=g09_opt_ir_radio,x='W2mag',y='W1_W2', hue='KMeans',fill=True, legend=False,ax=g.ax_joint)
...
sns.kdeplot(data=g09_opt_ir_radio,x='W2mag', hue='KMeans',fill=True, legend=False,ax=g.ax_marg_x)
sns.kdeplot(data=g09_opt_ir_radio,y='W1_W2', hue='KMeans',fill=True, legend=False,ax=g.ax_marg_y)
...
g1 = sns.JointGrid()
sns.kdeplot(data=g09_opt_ir_radio,x='W2_W3',y='W1_W2', hue='KMeans',fill=True, legend=False,ax=g1.ax_joint)
sns.kdeplot(data=g09_opt_ir_radio,x='W2_W3',y='W1_W2',hue='mat_index',
            palette=['green','blue'],legend=False,ax=g1.ax_joint)
sns.kdeplot(data=g09_opt_ir_radio,x='W2_W3', hue='KMeans',fill=True, legend=False,ax=g1.ax_marg_x)
sns.kdeplot(data=g09_opt_ir_radio,y='W1_W2', hue='KMeans',fill=True, legend=False,ax=g1.ax_marg_y)
...
g2 = sns.JointGrid()
sns.kdeplot(data=g09_opt_ir_radio,y='W2_W3',x='K_W2', hue='KMeans',fill=True, legend=False,ax=g2.ax_joint)
sns.kdeplot(data=g09_opt_ir_radio,y='W2_W3',x='K_W2',hue='ki_index',
            palette=['green','blue'],legend=False,ax=g2.ax_joint)
sns.kdeplot(data=g09_opt_ir_radio,y='W2_W3', hue='KMeans',fill=True, legend=False,ax=g2.ax_marg_y)
sns.kdeplot(data=g09_opt_ir_radio,x='K_W2', hue='KMeans',fill=True, legend=False,ax=g2.ax_marg_x)
...
sns.kdeplot(x=np.log10(g09_opt_ir_radio.radio_flux),y=np.log10(g09_opt_ir_radio.W3_flux), 
            hue=g09_opt_ir_radio.KMeans,fill=True, legend=False, ax=g.ax_joint)
sns.kdeplot(x=np.log10(g09_opt_ir_radio.radio_flux),y=np.log10(g09_opt_ir_radio.W3_flux),
            hue=g09_opt_ir_radio.radio_index,palette=['green','blue'],legend=False,ax=g.ax_joint)
sns.kdeplot(x=np.log10(g09_opt_ir_radio.radio_flux), hue=g09_opt_ir_radio.KMeans,
            fill=True, legend=False,ax=g.ax_marg_x)
sns.kdeplot(y=np.log10(g09_opt_ir_radio.W3_flux), hue=g09_opt_ir_radio.KMeans,fill=True,
            legend=False,ax=g.ax_marg_y)
