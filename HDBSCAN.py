...
labels = cluster.fit_predict(input_matrix_scaled)
n_clusters=len(set(labels))- (1 if -1 in labels else 0)
print('No of clusters:',n_clusters)

input_matrix['HDBSCAN'] = labels

sns.scatterplot(data=input_matrix,x='logn2ha',y='logo3hb',hue='HDBSCAN',legend=True,palette=col[10:])
